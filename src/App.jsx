    ...
    <>
      ...
      <div className=" flex w-full h-96 items-center justify-center bg-gray-50">
        <div className=" w-1/3 h-1/3 border-2 border-black py-3 px-3 bg-gray-200" >
          <form action="flex flex-col gap-5 submit" >
            {/* receivers wallet */}
            <div className="flex justify-between bg-gray-50 items-center rounded-lg px-2">
              <input type="text" id="address" name="walletAddress" placeholder="Wallet Address" className="p-2 bg-transparent w-10/12"/>
              <svg 
            ...
            <input type="amount" id="amount" name="amount" placeholder="Amount" className="p-2 bg-transparent w-10/12"></input>
          </form>
        </div>
      </div>
    </>
